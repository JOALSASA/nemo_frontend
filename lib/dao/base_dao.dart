...
abstract class BaseDAO {
  ...
  Future<Response> put(
    ...
    try {
      ...
      _logger.d(
          'PUT REQUEST: url: ${url.toString()}, headers: ${headers.toString()}, body: $body');
      var response = await http.put(url,
          headers: headers, encoding: encoding);
      _logger.d(
          'PUT RESPONSE: status: ${response.statusCode} url: ${url.toString()}, headers: ${headers.toString()}, body: ${response.body}');
